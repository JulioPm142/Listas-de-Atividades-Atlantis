...
telefone.ddd = '12'
telefone.numero = '988123456'
let TelefonesList=[]
TelefonesList.push(telefone)
cliente.telefones=TelefonesList

let documento = new Documento()
documento.tipo = TipoDocumento.CPF
documento.numero = '11111111111'
documento.dataExpedicao = new Date('2022-01-01')
let DocumentosList=[]
DocumentosList.push(documento)
cliente.documentos=DocumentosList
