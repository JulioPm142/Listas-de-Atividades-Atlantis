...
export default class Endereco implements Prototipo {
    ...
    public setRua(newRua: string) {
        this.rua = newRua;
    }

    public setBairro(newBairro: string) {
        this.bairro = newBairro;
    }
    
    public setCidade(newCidade: string) {
    ...
    public setPais(newPais: string) {
        this.pais = newPais;
    }
    public setCodigoPostal(newCodPostal: string) {
        this.codigoPostal = newCodPostal;
    }          
